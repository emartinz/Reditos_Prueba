...
class UserDetailsServiceTest {
	...
	void testSaveOrUpdateUserDetails_whenUserExists() {
		...
		UserDetails updatedUser = userDetailsService.saveOrUpdateUserDetails(1L, "testUser", "newemail@example.com",
	...
	void testSaveOrUpdateUserDetails_whenUserDoesNotExist() {
		...
		UserDetails createdUser = userDetailsService.saveOrUpdateUserDetails(1L, "nuevoUser", "nuevoUser@example.com",
				"Nombre", "Apellido");
	...
	void testFindOrCreateUser_whenUserDoesNotExist() {
		// Simulamos que el repositorio no encuentra el usuario con el nombre de usuario
		// "nuevoUser"
		...
		// Verificamos que el repositorio haya buscado por el username "nuevoUser" y
		// luego haya guardado el nuevo usuario
