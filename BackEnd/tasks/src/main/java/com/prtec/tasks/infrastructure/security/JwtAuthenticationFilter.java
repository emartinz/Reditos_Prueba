package com.prtec.tasks.infrastructure.security;
 ...
 * la validez de los tokens JWT. Si el token es válido, establece la
 * autenticación
 ...
 * <li>Establece la autenticación en el contexto de seguridad de Spring si el
 * token es válido.</li>
 * </ul>
 *
 * <p>
 * Si el token es inválido o no está presente, el filtro simplemente pasa la
 * solicitud
 * al siguiente filtro sin establecer autenticación.
 * </p>
 *
 * @author Edgar Andres
 * @version 1.0
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
	...
	protected void doFilterInternal(@NonNull HttpServletRequest request,
		...
		// Permitir que el navegador se comunique con el backend en caso de solicitudes
		// preflight (OPTIONS)
