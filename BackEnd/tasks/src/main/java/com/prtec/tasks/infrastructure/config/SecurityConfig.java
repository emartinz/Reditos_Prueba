...
import com.prtec.tasks.infrastructure.security.JwtAuthenticationFilter;
 ...
 *
 * <p>
 * Esta clase establece:
 * <ul>
 * <li>Las reglas de autorización y autenticación.</li>
 * <li>La integración con el filtro JWT para validar tokens de acceso.</li>
 * <li>La configuración de CORS y CSRF según las necesidades de la
 * aplicación.</li>
 * <li>El manejo de excepciones y puntos de entrada no autorizados.</li>
 * </ul>
 *
 * <p>
 * Además, define beans como PasswordEncoder y AuthenticationManager para
 * asegurar el correcto manejo de credenciales y autenticación.
 * </p>
 *
 * @author Edgar Andres
 * @version 2.0
