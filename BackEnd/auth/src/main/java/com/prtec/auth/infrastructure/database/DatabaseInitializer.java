package com.prtec.auth.infrastructure.database;
...
public class DatabaseInitializer implements CommandLineRunner {
    ...
    public void run(String... args) {
        try {
            ...
            logger.debug("Validacion o creacion de roles base, completados.");
            ...
            if (entityManager.createQuery("SELECT u FROM User u WHERE u.username = 'admin'").getResultList().isEmpty()) {
                ...
                logger.debug("Usuarios creado.");
            }

            logger.debug("Datos iniciales cargados correctamente.");
        } catch (Exception e) {
