...
/**
 * Clase para facilitar operaciones relacionadas con archivo de configuracion Yaml
 */
public class YamlUtil {
     ...
     * y devuelve un arreglo limpio, separado por comas, sin espacios ni saltos de línea.
     * 
     * @param original
     * @return
     */
